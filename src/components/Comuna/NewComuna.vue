                ...
                <form @submit.prevent="updateComuna">
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="comu_codi" placeholder="Codigo"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="comu_nomb" placeholder="Codigo"
                                v-model="Comunas.comu_nom">
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label for="comu_nomb" class="form-label">Municipio</label>
                        <div class="input-group">
                            <div class="input-group-text"> <font-awesome-icon icon="bank" /></div>
                            <select class="form-select" v-model="Comunas.muni_codi">
